describe("Metadata dialog", function() {
  ...
  it("should remove all javascript events included in the description", function() {
    var o = {};
    var new_view = new cdb.admin.MetadataDialog({
      vis: vis,
      user: user,
    ...
    new_view.render();
    new_view.$('input[name="name"]').val('name');
    new_view.$('textarea[name="description"]').val("<a href='#/test' onclick='alert(\'paco\')'>hello hello</a> [This link](http://example.net/)");
    new_view._saveModel();
    expect(o.description).toBe("<a href='#/test'>hello hello</a> [This link](http://example.net/)");

    new_view.render();
    new_view.$('input[name="name"]').val('name');
    new_view.$('textarea[name="description"]').val("<a href='#/test' onclick='alert(\'paco\')'>hello hello</a>");
    new_view._saveModel();
    expect(o.description).toBe("<a href='#/test'>hello hello</a>");

    new_view.render();
    new_view.$('input[name="name"]').val('name');
    new_view.$('textarea[name="description"]').val('[This link](http://example.net/)');
    new_view._saveModel();
    expect(o.description).toBe('[This link](http://example.net/)');
