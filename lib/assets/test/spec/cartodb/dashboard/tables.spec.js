describe("Dashboard tables view", function() {
  ...
  describe("Table list", function() {
    ...
    it("shouldn't render any html tag in the table description", function() {
      var table = generateTableData('table_name1', 'test');
      table.description = "<a href='#/test' onlick='alert(\'paco\')'>hello hello</a> [This link](http://example.net/)";
      tables.reset([ table ]);
      var table_item = _.find(view._subviews, function() { return true });
      expect(table_item.$('.table-description').html()).toBe('hello hello This link');

      table.description = "<a href='#/test' onlick='alert(\'paco\')'>hello hello</a>";
      tables.reset([ table ]);
      var table_item = _.find(view._subviews, function() { return true });
      expect(table_item.$('.table-description').html()).toBe('hello hello');

      table.description = "[This link](http://example.net/)";
      tables.reset([ table ]);
      var table_item = _.find(view._subviews, function() { return true });
      expect(table_item.$('.table-description').html()).toBe('This link');

      table.description = "";
      tables.reset([ table ]);
      var table_item = _.find(view._subviews, function() { return true });
      expect(table_item.$('.table-description').length).toBe(0);
    });
