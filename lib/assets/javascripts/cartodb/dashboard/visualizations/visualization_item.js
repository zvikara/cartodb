  ...
  cdb.admin.dashboard.VisualizationItem = cdb.core.View.extend({
    ...
    render: function() {
      ...
      if (this.model) {
        ...
        // Steps for description convertion:
        //  - Remove direct html
        //  - Convert markdown to html
        //  - Finally remove html generated by the markdown syntax
        var description       = cdb.Utils.stripHTML(markdown.toHTML(cdb.Utils.stripHTML(this.model.get("description"))));
        var clean_description = this._cleanString(description, 55);
