...
cdb.admin.dashboard.TableItem = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var created_at = moment(moment(attrs.created_at).format("YYYY-MM-DDTHH:mm +0000")).fromNow();
    var updated_at = moment(moment(attrs.updated_at).format("YYYY-MM-DDTHH:mm +0000")).fromNow();
    ...
    this.$el.append(this.template(_.extend(attrs, template_options)));
