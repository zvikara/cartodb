...
cdb.admin.mod.BubbleLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    items.push(new cdb.geo.ui.LegendItemModel({ legend_type: "bubble", name: "Left label",  type: "text",  sticky: this.leftSticky, value: this.leftLabel }));
    items.push(new cdb.geo.ui.LegendItemModel({ legend_type: "bubble", name: "Right Label", type: "text",  sticky: this.rightSticky, value: this.rightLabel }));
