    ...
    */
    keyBind: function() {
      ...
      cdb.god.bind('hotkey:d', function(e) {
        self.menu.layers.isOpen
          ? self.menu.layers.hide()
          : self.menu.layers.show('sql_mod');
      });
      cdb.god.bind('hotkey:s', function(e) {
        self.menu.layers.show('sql_mod');
      })
      cdb.god.bind('hotkey:c', function(e) {
        self.menu.layers.show('style_mod');
      })
    },
    ...
    _initViews: function() {
      ...
      this.menu = new cdb.admin.LayersDialog({
        vis: this.vis,
      ...
      this.menu.layers.hide();
      this.addView(this.menu);

      this.menu.layers.bind('switch', function(layerView) {
    ...
    _initTableMap: function() {
      ...
      this.mapTab.bind('missingClick', self.menu.layershide, self.menu.layers);
    ...
    activeView: function(name) {
      ...
      this.menu.layers.setActiveWorkView(name);
