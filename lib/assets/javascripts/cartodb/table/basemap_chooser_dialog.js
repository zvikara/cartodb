  ...
  cdb.admin.BaseMapAdder = cdb.admin.BaseDialog.extend({
      ...
      if (bboxes && bboxes.length > 0) {
        ...
        if (!bbox) {
          ...
          bbox =  {
            ...
            projection:  projection.replace(/epsg:/gi, "")
          };
    ...
    _setBounds: function(bounding_box) {
      ...
      table.map.setBounds([
        [bounding_box.attributes.ymin, bounding_box.attributes.xmax],
        [bounding_box.attributes.ymax, bounding_box.attributes.xmin]
      ]);
