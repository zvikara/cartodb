  ...
  cdb.admin.MapboxBasemapChooserPane = cdb.admin.BasemapChooserPane.extend({
    ...
    checkTileJson: function(val) {
      ...
      if (type == 'mapbox') {
        ...
        this.trigger('successChooser', { tiles: [url] });
        ...
        image.onload = function(e) {
          self.trigger('successChooser', { tiles: [self._lowerXYZ(val)] });
        }
        ...
        image.onload = function(e) {
          self.trigger('successChooser', { tiles: [self._MAPBOX.base + "v" + self._MAPBOX.version + "/" + val + "/{z}/{x}/{y}.png"] });
        }
