  ...
  cdb.admin.WMSBasemapLayersPaneItemView = cdb.core.View.extend({
    ...
    _containsValidProjections: function() {
      ...
      var is3857   = srs.indexOf("3857") != -1;
      var is900913 = srs.indexOf("900913") != -1;

      //debugger;
      if (!is3857 && !is900913) return false;
      if (bounding_boxes && bounding_boxes.length == 0 && !srs)     return true;
