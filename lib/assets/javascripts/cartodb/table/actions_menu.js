  ...
  cdb.admin.LayersDialog = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      // add tabs
      this.$el.append('<div class="map_elements_tabs"> <a class="js-layers" href="#layers">layers</a><a href="#element">elements</a></div>');
  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    initialize: function() {
      ...
      this.model.bind('change:isShowingAll', this._resetLayers, this)
