...
cdb.admin.NewHeader = cdb.core.View.extend({
  ...
  render: function() {
    var template = this.getTemplate('table/views/new_header');
    this.$el.append(template({
      visName: this.options.visualization.get('name')
    }));
