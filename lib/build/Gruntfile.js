 ...
 var timer = require("grunt-timer");
  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      // Generate error html files
      template: require('./tasks/template.js').task(),
    ...
    grunt.registerTask('statics',   ['template']);
    ...
    grunt.registerTask('default',   ['clean', 'config', 'cdb', 'concat:js', 'css', 'jst', 'template', 'manifest']);
