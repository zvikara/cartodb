  ...
  module NamedMapsWrapper
        ...
        @headers = { 
          ...
          followlocation: true
				...
				raise HTTPResponseError, "#{response.code} #{response.request.url} #{response.body} (GET)" if response.code != 200
          ...
          followlocation: true
				...
				if response.code == 200
					...
					raise HTTPResponseError, "#{response.code} #{response.request.url} #{response.body} (GET)"
				end
			end #get
